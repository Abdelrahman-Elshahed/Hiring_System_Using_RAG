...
from config.config import embedding_model, INITIAL_CANDIDATES, FINAL_RANKING, AZURE_CONFIG, DEPLOYMENT_NAME
...
def rank_cvs(job_description_path, faiss_index, metadata):
